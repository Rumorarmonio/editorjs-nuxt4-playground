...
- Открытый технический вопрос активного этапа: какой минимальный helper нужен для create/destroy nested Editor.js instance, чтобы не вводить преждевременно полную reusable rich field abstraction.
...
Следующий шаг: спроектировать минимальный контракт nested rich paragraph data для `SectionIntro` и добавить shared type/registry entry без реализации общей rich field system.
