...
- Активный scope по `SPEC.md`: Клавиатурная навигация и accessibility polish; предыдущий этап Light/Dark theme завершён.
...
Следующий шаг: составить короткий список optional improvements для этапа Некритичные улучшения и выбрать первый небольшой сценарий, который можно реализовать без изменения content JSON schema и крупного перепроектирования.
