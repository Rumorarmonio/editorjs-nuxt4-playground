...
- Следующий активный scope по `SPEC.md`: первый простой custom block без nested editors.
...
Следующий шаг: спланировать и реализовать первый простой custom block без nested editors, используя `editor/admin/fields` для plain editor UI.
