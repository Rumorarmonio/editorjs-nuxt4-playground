...
- Активный scope по `SPEC.md`: Локализация UI редактора завершена; следующий крупный этап по спецификации — Light/Dark theme.
...
Следующий шаг: перейти к следующему крупному этапу по спецификации — Light/Dark theme.
