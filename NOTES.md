...
- Runtime-удобство plain fields нужно проверить на первом реальном custom block; отдельный demo harness на этапе plain fields не добавлялся.
...
Следующий шаг: реализовать `Notice` custom block без nested editors — добавить shared type/registry, Editor.js tool class на plain fields, renderer component, guard/normalization и проверку полного цикла create/edit/save/reload/render.
