...
- Активный scope по `SPEC.md`: Локализация UI редактора после завершения Masks.
...
Следующий шаг: проанализировать текущие hardcoded UI strings в app shell, Editor.js config, custom tools, tunes и field builders перед подключением `vue-i18n`.
