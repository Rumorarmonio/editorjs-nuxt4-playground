...
Следующий крупный шаг: выбрать новый scope после базовой версии — например custom blocks, tunes, nested editors, media workflow или дополнительный accessibility/theme polish.
