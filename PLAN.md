...
Следующий крупный этап: согласовать и зафиксировать стартовый bootstrap `Nuxt 4` проекта с минимальной файловой структурой и без преждевременной кастомизации редактора.
